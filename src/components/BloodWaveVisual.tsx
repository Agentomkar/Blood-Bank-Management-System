  ...
  return (
    <div ref={ref} className="absolute inset-0 overflow-hidden pointer-events-none" style={{ willChange: "transform" }}>
      ...
      <motion.div
        ...
        className="absolute left-1/2 top-[22%] h-[42vh] w-[42vw] -translate-x-1/2 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(255,118,118,0.16),transparent_68%)] blur-3xl"
      />
      <motion.div
      ...
      <motion.svg
        viewBox="0 0 420 560"
        className="absolute left-1/2 top-[10%] h-[54vh] max-h-[560px] min-h-[320px] w-auto -translate-x-1/2 drop-shadow-[0_0_80px_rgba(220,20,60,0.42)]"
